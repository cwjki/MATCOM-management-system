...
class SubjectDescriptionSerializer(ModelSerializer):
    ...
    #     time_period_id = validated_data.get('time_period_id')
    #     teaching_group_id = validated_data.get('teaching_group_id')
    #     number_of_hours = validated_data.get('number_of_hours')
    #     number_of_groups = validated_data.get('number_of_groups')
