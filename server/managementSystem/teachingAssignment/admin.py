...
from .models import Career, ClassType, Department, Professor, SchoolYear, ScientificDegree, Snippet, StudyPlan, Subject, TeachingAssignment, TeachingCategory, TeachingPlanning, YearPeriod
