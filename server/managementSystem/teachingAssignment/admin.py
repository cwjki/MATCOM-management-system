...
from .models import Career, ClassType, Department, Professor, Student, TeachingAssignment, TeachingGroup, ScientificDegree, StudyPlan, Subject, TeachingCategory, Thesis, ThesisCommittee, TimePeriod, Semester, CarmenTable, SubjectDescription, Faculty
